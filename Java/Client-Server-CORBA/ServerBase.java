...
import ServerInterfacePackage.ResourceException;
...
public class ServerBase extends ServerInterfacePOA {
    ...
    public ServerBase(ORB orb, String serverPrefix, int udpPort) {
    ...
    @Override
    public String addResource(String resourceID, String resourceName, int duration) throws ResourceException {
    ...
    public String removeResource(String resourceID, int duration) throws ResourceException {
        String resourcePrefix = getIdResource(resourceID);
        if(!resourcePrefix.equalsIgnoreCase(serverPrefix)){
            int targetPort = findServerPort(resourcePrefix);
            String message;
    ...
    @Override
    public String listResourceAvailability(String resourceName) throws ResourceException {
    ...
    @Override
    public String requestResource(String coordinatorID, String resourceID, int duration) throws ResourceException {
        String resourcePrefix = getIdResource(resourceID);
        if(!resourcePrefix.equalsIgnoreCase(serverPrefix)){
            int targetPort = findServerPort(resourcePrefix);
    ...
    @Override
    public String findResource(String coordinatorID, String resourceName) throws ResourceException {
    ...
    @Override
    public String returnResource(String coordinatorID, String resourceID) throws ResourceException {
        String resourcePrefix = getIdResource(resourceID);
        if(!resourcePrefix.equalsIgnoreCase(serverPrefix)){
            int targetPort = findServerPort(resourcePrefix);
    ...
    @Override
    public String swapResource(String coordinatorID, String oldResourceID, String oldResourceType, String newResourceID, String newResourceType) throws ResourceException {
    ...
    private String processUDPMessage(String message, DatagramPacket packet) throws IOException, ResourceException {
    ...
    public static class ServerThread implements Runnable {
        ...
        public ServerThread(int port, String serverName, int udpPort, ORB orb) {
            this.port = port;
    ...
    public static void main(String[] args) {
        ...
        //Initialize ORB for each server
        ...
        Thread serverQUE = new Thread(() -> {
            String[] orbArgs = {"-ORBInitialHost", "localhost", "-ORBInitialPort", "1050"};
            ORB orb = ORB.init(orbArgs, null);
            new ServerThread(7778, "QUE", 7878, orb).run();
        });
        serverThreads.add(serverQUE);
        serverQUE.start();

        Thread serverSHE = new Thread(() -> {
            String[] orbArgs = {"-ORBInitialHost", "localhost", "-ORBInitialPort", "1050"};
            ORB orb = ORB.init(orbArgs, null);
            new ServerThread(7779, "SHE", 7879, orb).run();
        });
